...
{-
Behavior : Take function takes in two arguments 1st is an int and second 
is a list, and returns a list with number of elements upto the 1st 
argument. So here 

>>> makeSnippet 20 "hello"
"Description: hello..."
-}
